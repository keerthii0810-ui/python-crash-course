...
print(my_set,type(my_set)) #printing the set and its type
print(my_set.count(5)) #this will raise an error because sets do not have a count method
print(my_set.append(60)) #this will add the element 60 to the set
